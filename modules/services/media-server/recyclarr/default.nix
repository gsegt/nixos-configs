      ...
      configuration = {
        radarr = {
          radarr = {
            ...
            custom_formats = [
              # Remux-1080p - Anime specific custom formats
              {
                trash_ids = [
              ...
              # HD Bluray + WEB specific custom formats
              {
                trash_ids = [
              ...
              #   ];
              # }
              # Remux + WEB 1080p specific custom formats
              # Audio
              {
                trash_ids = [
              ...
              #   ];
              # }
              # Remux + WEB 2160p specific custom formats
              # Audio
              {
                trash_ids = [
                  # Uncomment the next section to enable Advanced Audio Formats
              ...
              # UHD Bluray + WEB specific custom formats
              # Audio
              {
                trash_ids = [
                  # Uncomment the next section to enable Advanced Audio Formats
        ...
        sonarr = {
          sonarr = {
            ...
            custom_formats = [
              ...
              # WEB-1080p specific custom formats
              # Optional
              {
                trash_ids = [
              ...
              # WEB-2160p specific custom formats
              # HDR Formats
              {
                trash_ids = [
                  # Comment out the next line if you and all of your users' setups are fully DV compatible
